...
extension AnimatedSKNode {
    ...
    func animateMovementAndFade(
        distance: CGFloat, duration: TimeInterval, direction: MovementDirection, fadeOut: Bool,
        completion: (() -> Void)? = nil
    ) {
    ...
    func animateMoveWithFade(
        distance: CGFloat, duration: TimeInterval = 0.25, direction: MovementDirection,
        fadeOut: Bool, completion: (() -> Void)? = nil
    ) {
        animateMovementAndFade(
            distance: distance, duration: duration, direction: direction, fadeOut: fadeOut,
