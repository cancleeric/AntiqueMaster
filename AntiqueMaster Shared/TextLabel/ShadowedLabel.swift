...
//  修改於 2024/11/01：調整 shadowLabel 的位置，使其根據字體大小動態調整。
...
class ShadowedLabel: SKNode {
    ...
    init(
        text: String, fontSize: CGFloat, fontColor: UIColor = .systemBrown,
        ...
        self.shadowLabel.position = CGPoint(x: fontSize * 0.1, y: -fontSize * 0.1)
